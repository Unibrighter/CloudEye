...
import static com.utils.csv.Constants.BACKSPACE;
import static com.utils.csv.Constants.CR;
import static com.utils.csv.Constants.END_OF_STREAM;
import static com.utils.csv.Constants.FF;
import static com.utils.csv.Constants.LF;
import static com.utils.csv.Constants.TAB;
import static com.utils.csv.Constants.UNDEFINED;
import static com.utils.csv.Token.Type.COMMENT;
import static com.utils.csv.Token.Type.EOF;
import static com.utils.csv.Token.Type.EORECORD;
import static com.utils.csv.Token.Type.INVALID;
import static com.utils.csv.Token.Type.TOKEN;
            ...
            if (readEndOfLine(ch)) {
                ...
                if (unescaped == END_OF_STREAM) { // unexpected char after
                    ...
                    token.content.append((char) ch)
                            .append((char) reader.getLastChar());
                }
                else {
...
//                            log.error("csv reading error, current line: " + getCurrentLineNumber());
